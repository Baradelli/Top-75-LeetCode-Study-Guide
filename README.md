...
It currently includes **73 organized problems** with explanations in both languages.
The solved problems are now grouped by type: `array`, `binary`, `dynamic-programming`, `graph`, `interval`, `linked-list`, `matrix`, `string`, and `tree`.
...
Atualmente ele inclui **73 problemas organizados** com explicações nos dois idiomas.
