# Top 75 LeetCode Study Guide

- [Português](./README.pt.md)
- [English](./README.en.md)

This repository is organized to help you study the **Top 75 LeetCode Questions** in a clean and repeatable way.
It currently includes **75 organized problems** with explanations in both languages.
The solved problems are now grouped by type: `array`, `binary`, `dynamic-programming`, `graph`, `heap`, `interval`, `linked-list`, `matrix`, `string`, and `tree`.
...
Atualmente ele inclui **75 problemas organizados** com explicações nos dois idiomas.
