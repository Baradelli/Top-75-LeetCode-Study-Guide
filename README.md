...
It currently includes **56 organized problems** with explanations in both languages.
The solved problems are now grouped by type: `array`, `binary`, `dynamic-programming`, `graph`, `interval`, `linked-list`, `matrix`, and `string`.
...
Atualmente ele inclui **56 problemas organizados** com explicações nos dois idiomas.
