...
It currently includes **46 organized problems** with explanations in both languages.
The solved problems are now grouped by type: `array`, `binary`, `dynamic-programming`, `graph`, `interval`, `linked-list`, and `matrix`.
...
Atualmente ele inclui **46 problemas organizados** com explicações nos dois idiomas.
